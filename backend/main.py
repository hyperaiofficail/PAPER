...
# Enable CORS
# Security: allow_origins=["*"] with allow_credentials=True is invalid and insecure.
# We restrict it to specific origins defined by environment variable or default to frontend dev server.
